...
//  A5plist
//
//  Created by shenZhenNewWorld on 15-6-3.
...
int main(int argc, const char * argv[])
{
    ...
    @autoreleasepool {
        ...
        NSString * path = @"/Users/shenZhenNewWorld/Desktop/课堂练习/3/3/A5plist/A5plist/QF.plist";
        ...
        NSLog(@"%@",dic);
        [dic writeToFile:@"/Users/shenZhenNewWorld/Desktop/1.plist" atomically:YES];
